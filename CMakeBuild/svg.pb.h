...
PROTOBUF_NAMESPACE_OPEN
template<> ::serializator::Color* Arena::CreateMaybeMessage<::serializator::Color>(Arena*);
template<> ::serializator::Point* Arena::CreateMaybeMessage<::serializator::Point>(Arena*);
template<> ::serializator::Rgb* Arena::CreateMaybeMessage<::serializator::Rgb>(Arena*);
template<> ::serializator::Rgba* Arena::CreateMaybeMessage<::serializator::Rgba>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace serializator {
...
class Rgb final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serializator.Rgb) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:serializator.Rgb)
 private:
  class _Internal;
...
class Rgba final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serializator.Rgba) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:serializator.Rgba)
 private:
  class _Internal;
...
class Point final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serializator.Point) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:serializator.Point)
 private:
  class _Internal;
...
class Color final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serializator.Color) */ {
 public:
  ...
  // .serializator.Rgb rgb = 2;
  bool has_rgb() const;
  private:
  bool _internal_has_rgb() const;
  public:
  void clear_rgb();
  const ::serializator::Rgb& rgb() const;
  PROTOBUF_NODISCARD ::serializator::Rgb* release_rgb();
  ::serializator::Rgb* mutable_rgb();
  void set_allocated_rgb(::serializator::Rgb* rgb);
  private:
  const ::serializator::Rgb& _internal_rgb() const;
  ::serializator::Rgb* _internal_mutable_rgb();
  public:
  void unsafe_arena_set_allocated_rgb(
      ::serializator::Rgb* rgb);
  ::serializator::Rgb* unsafe_arena_release_rgb();

  // .serializator.Rgba rgba = 3;
  bool has_rgba() const;
  private:
  bool _internal_has_rgba() const;
  public:
  void clear_rgba();
  const ::serializator::Rgba& rgba() const;
  PROTOBUF_NODISCARD ::serializator::Rgba* release_rgba();
  ::serializator::Rgba* mutable_rgba();
  void set_allocated_rgba(::serializator::Rgba* rgba);
  private:
  const ::serializator::Rgba& _internal_rgba() const;
  ::serializator::Rgba* _internal_mutable_rgba();
  public:
  void unsafe_arena_set_allocated_rgba(
      ::serializator::Rgba* rgba);
  ::serializator::Rgba* unsafe_arena_release_rgba();

  void clear_color();
  ColorCase color_case() const;
  // @@protoc_insertion_point(class_scope:serializator.Color)
 private:
  class _Internal;
  void set_has_name();
  void set_has_rgb();
  ...
  struct Impl_ {
    union ColorUnion {
      ...
      ::serializator::Rgb* rgb_;
      ::serializator::Rgba* rgba_;
    } color_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
inline uint32_t Rgb::red() const {
  // @@protoc_insertion_point(field_get:serializator.Rgb.red)
...
inline void Rgb::set_red(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Rgb.red)
}
...
inline uint32_t Rgb::green() const {
  // @@protoc_insertion_point(field_get:serializator.Rgb.green)
...
inline void Rgb::set_green(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Rgb.green)
}
...
inline uint32_t Rgb::blue() const {
  // @@protoc_insertion_point(field_get:serializator.Rgb.blue)
...
inline void Rgb::set_blue(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Rgb.blue)
}
...
inline uint32_t Rgba::red() const {
  // @@protoc_insertion_point(field_get:serializator.Rgba.red)
  return _internal_red();
}
...
inline void Rgba::set_red(uint32_t value) {
  _internal_set_red(value);
  // @@protoc_insertion_point(field_set:serializator.Rgba.red)
}
...
inline uint32_t Rgba::green() const {
  // @@protoc_insertion_point(field_get:serializator.Rgba.green)
  return _internal_green();
}
...
inline void Rgba::set_green(uint32_t value) {
  _internal_set_green(value);
  // @@protoc_insertion_point(field_set:serializator.Rgba.green)
}
...
inline uint32_t Rgba::blue() const {
  // @@protoc_insertion_point(field_get:serializator.Rgba.blue)
  return _internal_blue();
}
...
inline void Rgba::set_blue(uint32_t value) {
  _internal_set_blue(value);
  // @@protoc_insertion_point(field_set:serializator.Rgba.blue)
}
...
inline double Rgba::opacity() const {
  // @@protoc_insertion_point(field_get:serializator.Rgba.opacity)
...
inline void Rgba::set_opacity(double value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Rgba.opacity)
}
...
inline double Point::x() const {
  // @@protoc_insertion_point(field_get:serializator.Point.x)
  return _internal_x();
}
...
inline void Point::set_x(double value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Point.x)
}
...
inline double Point::y() const {
  // @@protoc_insertion_point(field_get:serializator.Point.y)
  return _internal_y();
}
...
inline void Point::set_y(double value) {
  ...
  // @@protoc_insertion_point(field_set:serializator.Point.y)
}
...
inline void Color::clear_name() {
  if (_internal_has_name()) {
    _impl_.color_.name_.Destroy();
    clear_has_color();
  }
}
inline const std::string& Color::name() const {
  // @@protoc_insertion_point(field_get:serializator.Color.name)
...
inline void Color::set_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_name()) {
    clear_color();
    set_has_name();
    _impl_.color_.name_.InitDefault();
  }
  _impl_.color_.name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:serializator.Color.name)
}
inline std::string* Color::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:serializator.Color.name)
  return _s;
}
inline const std::string& Color::_internal_name() const {
  if (_internal_has_name()) {
    return _impl_.color_.name_.Get();
  }
...
inline void Color::_internal_set_name(const std::string& value) {
  ...
  _impl_.color_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* Color::_internal_mutable_name() {
  ...
  return _impl_.color_.name_.Mutable(      GetArenaForAllocation());
}
inline std::string* Color::release_name() {
  // @@protoc_insertion_point(field_release:serializator.Color.name)
  if (_internal_has_name()) {
    clear_has_color();
    return _impl_.color_.name_.Release();
  } else {
    return nullptr;
  }
}
inline void Color::set_allocated_name(std::string* name) {
  ...
  if (name != nullptr) {
    set_has_name();
    _impl_.color_.name_.InitAllocated(name, GetArenaForAllocation());
  }
  // @@protoc_insertion_point(field_set_allocated:serializator.Color.name)
}
...
inline ::serializator::Rgb* Color::release_rgb() {
  // @@protoc_insertion_point(field_release:serializator.Color.rgb)
  if (_internal_has_rgb()) {
    clear_has_color();
    ::serializator::Rgb* temp = _impl_.color_.rgb_;
    if (GetArenaForAllocation() != nullptr) {
...
inline const ::serializator::Rgb& Color::_internal_rgb() const {
  return _internal_has_rgb()
      ? *_impl_.color_.rgb_
      : reinterpret_cast< ::serializator::Rgb&>(::serializator::_Rgb_default_instance_);
}
inline const ::serializator::Rgb& Color::rgb() const {
  // @@protoc_insertion_point(field_get:serializator.Color.rgb)
  return _internal_rgb();
}
inline ::serializator::Rgb* Color::unsafe_arena_release_rgb() {
  // @@protoc_insertion_point(field_unsafe_arena_release:serializator.Color.rgb)
  if (_internal_has_rgb()) {
    clear_has_color();
    ::serializator::Rgb* temp = _impl_.color_.rgb_;
    _impl_.color_.rgb_ = nullptr;
...
inline void Color::unsafe_arena_set_allocated_rgb(::serializator::Rgb* rgb) {
  clear_color();
  if (rgb) {
    set_has_rgb();
    _impl_.color_.rgb_ = rgb;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:serializator.Color.rgb)
}
inline ::serializator::Rgb* Color::_internal_mutable_rgb() {
  if (!_internal_has_rgb()) {
    clear_color();
    set_has_rgb();
    _impl_.color_.rgb_ = CreateMaybeMessage< ::serializator::Rgb >(GetArenaForAllocation());
  }
  return _impl_.color_.rgb_;
}
inline ::serializator::Rgb* Color::mutable_rgb() {
  ::serializator::Rgb* _msg = _internal_mutable_rgb();
  // @@protoc_insertion_point(field_mutable:serializator.Color.rgb)
  return _msg;
}
...
inline ::serializator::Rgba* Color::release_rgba() {
  // @@protoc_insertion_point(field_release:serializator.Color.rgba)
  if (_internal_has_rgba()) {
    clear_has_color();
    ::serializator::Rgba* temp = _impl_.color_.rgba_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::serializator::Rgba& Color::_internal_rgba() const {
  return _internal_has_rgba()
      ? *_impl_.color_.rgba_
      : reinterpret_cast< ::serializator::Rgba&>(::serializator::_Rgba_default_instance_);
}
inline const ::serializator::Rgba& Color::rgba() const {
  // @@protoc_insertion_point(field_get:serializator.Color.rgba)
  return _internal_rgba();
}
inline ::serializator::Rgba* Color::unsafe_arena_release_rgba() {
  // @@protoc_insertion_point(field_unsafe_arena_release:serializator.Color.rgba)
  if (_internal_has_rgba()) {
    clear_has_color();
    ::serializator::Rgba* temp = _impl_.color_.rgba_;
    _impl_.color_.rgba_ = nullptr;
...
inline void Color::unsafe_arena_set_allocated_rgba(::serializator::Rgba* rgba) {
  clear_color();
  if (rgba) {
    set_has_rgba();
    _impl_.color_.rgba_ = rgba;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:serializator.Color.rgba)
}
inline ::serializator::Rgba* Color::_internal_mutable_rgba() {
  if (!_internal_has_rgba()) {
    clear_color();
    set_has_rgba();
    _impl_.color_.rgba_ = CreateMaybeMessage< ::serializator::Rgba >(GetArenaForAllocation());
  }
  return _impl_.color_.rgba_;
}
inline ::serializator::Rgba* Color::mutable_rgba() {
  ::serializator::Rgba* _msg = _internal_mutable_rgba();
  // @@protoc_insertion_point(field_mutable:serializator.Color.rgba)
  return _msg;
}
