...
const uint32_t TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.height_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.padding_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.stop_radius_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.line_width_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.bus_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.bus_label_offset_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.stop_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.stop_label_offset_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.underlayer_color_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.underlayer_width_),
  PROTOBUF_FIELD_OFFSET(::serializator::RenderSettings, _impl_.color_palette_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::serializator::RenderSettings)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::serializator::_RenderSettings_default_instance_._instance,
};

const char descriptor_table_protodef_map_5frenderer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022map_renderer.proto\022\014serializator\032\tsvg."
  "proto\"\370\002\n\016RenderSettings\022\r\n\005width\030\001 \001(\001\022"
  "\016\n\006height\030\002 \001(\001\022\017\n\007padding\030\003 \001(\001\022\023\n\013stop"
  "_radius\030\004 \001(\001\022\022\n\nline_width\030\005 \001(\001\022\033\n\023bus"
  "_label_font_size\030\006 \001(\005\022-\n\020bus_label_offs"
  "et\030\007 \001(\0132\023.serializator.Point\022\034\n\024stop_la"
  "bel_font_size\030\010 \001(\005\022.\n\021stop_label_offset"
  "\030\t \001(\0132\023.serializator.Point\022-\n\020underlaye"
  "r_color\030\n \001(\0132\023.serializator.Color\022\030\n\020un"
  "derlayer_width\030\013 \001(\001\022*\n\rcolor_palette\030\014 "
  "\003(\0132\023.serializator.Colorb\006proto3"
  ;
...
class RenderSettings::_Internal {
 public:
  static const ::serializator::Point& bus_label_offset(const RenderSettings* msg);
  static const ::serializator::Point& stop_label_offset(const RenderSettings* msg);
  static const ::serializator::Color& underlayer_color(const RenderSettings* msg);
};

const ::serializator::Point&
...
RenderSettings::RenderSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:serializator.RenderSettings)
}
RenderSettings::RenderSettings(const RenderSettings& from)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::serializator::Point(*from._impl_.bus_label_offset_);
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_impl_.stop_label_offset_ = new ::serializator::Point(*from._impl_.stop_label_offset_);
  }
  if (from._internal_has_underlayer_color()) {
    _this->_impl_.underlayer_color_ = new ::serializator::Color(*from._impl_.underlayer_color_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:serializator.RenderSettings)
}
...
RenderSettings::~RenderSettings() {
  // @@protoc_insertion_point(destructor:serializator.RenderSettings)
...
// @@protoc_insertion_point(message_clear_start:serializator.RenderSettings)
...
uint8_t* RenderSettings::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:serializator.RenderSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:serializator.RenderSettings)
  return target;
}

size_t RenderSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:serializator.RenderSettings)
  size_t total_size = 0;
...
void RenderSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:serializator.RenderSettings)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::serializator::Point::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::serializator::Point::MergeFrom(
        from._internal_stop_label_offset());
  }
  if (from._internal_has_underlayer_color()) {
    _this->_internal_mutable_underlayer_color()->::serializator::Color::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:serializator.RenderSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::serializator::RenderSettings*
Arena::CreateMaybeMessage< ::serializator::RenderSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::serializator::RenderSettings >(arena);
}
